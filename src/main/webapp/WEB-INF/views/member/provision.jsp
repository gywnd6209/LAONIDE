...
<body>
	...
	<table width="100%" height="70%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        <tr> 
            <td>&nbsp; <b>회원가입약관</b></td>
        </tr>
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%; height: 100%" rows=10 readonly class=ed>제 1 장 : 총칙 
제 2 장 : 서비스 이용계약 
제 3 장 : 계약당사자의 의무 
제 4 장 : 서비스 이용 
제 5 장 : 계약해지 및 이용제한 
