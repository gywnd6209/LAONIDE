...
$(function(){
    ...
    $('#deleteBtn').click(function() {
		if(mem_id == bo_mem_id){
			$(location).attr('href', '${pageContext.request.contextPath }/admin/library/deleteLibraryInfo.do?bo_no=${libraryInfo.bo_no}');
		}else{
    ...
    $('form[name=updateFrm]').submit(function() {
		if(mem_id == bo_mem_id){
			...
			$(this).attr('action', '${pageContext.request.contextPath }/admin/library/updateLibraryInfo.do');
    ...
    $('#libraryReplyRegiBtn').click(function() {
		...
		// 댓글 등록 ajax
    	 $.ajax({
	         type : 'POST',
	         url : '${pageContext.request.contextPath}/admin/library/insertLibraryReply.do',
	         dataType : 'json', 
	         data : { 
...
function fn_updateReply(bo_no){
	...
	// 댓글 수정 ajax
	 $.ajax({
        type : 'POST',
        url : '${pageContext.request.contextPath}/admin/library/updateLibraryReply.do',
        dataType : 'json', 
        data : { 
       	 bo_cont 	: 	editContent,
       	 bo_writer  : 	'${LOGIN_ADMININFO.mem_nick}',
...
function deleteReply(bo_no) {
	...
	$.ajax({
		type : 'POST',
		url : '${pageContext.request.contextPath}/admin/library/deleteLibraryReply.do',
		dataType : 'json', 
		data : { 
			bo_no : 		bo_no
		},
...
<!--                        <input type="text" disabled="disabled" class="form-control"  id="bo_date" name="bo_date" /> -->
               ...
               <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                       <textarea id="bo_cont" name="bo_cont" style="height: 200px" rows="5" cols="5" class="form-control">${libraryInfo.bo_cont}</textarea>
...
<!-- 	                <div class="col-sm-10"> -->
	               		<span style="text-align: left; padding-right: 20px;"> 
							<i class="ti-save">&nbsp;${fileItem.file_name}
								<a href="${pageContext.request.contextPath}/admin/library/fileDownload.do?file_seq=${fileItem.file_seq }">
