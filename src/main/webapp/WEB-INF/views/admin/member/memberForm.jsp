...
<section class="login-block">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12">
				<form name="memberForm" action='${pageContext.request.contextPath }/admin/member/insertMember.do' method='post' class="md-float-material form-material">
					<div class="auth-box card">
						 <div class="card-block">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group form-primary">
										...
										<label class="float-label">ID입력 (영어소문자, 숫자포함 4~14글자)</label>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group form-primary">
										...
										<span class="form-bar"></span>
										<label class="float-label">비번확인</label>
									 </div>
								</div>
							</div>
								...
								<div class="col-md-12">
									<div class="checkbox-fade fade-in-primary">
										<label>
											...
											<span class="text-inverse"> <a href="#">약관 </a> 에 동의하시면 체크해주세요.</a></span>
										</label>
									 </div>
								</div>
							</div>
							<div class="row m-t-30">
								<div class="col-md-12">
									<button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">가입</button>
								</div>
							</div>
							<hr/>
							<div class="row">
								<div class="col-md-10">
									...
									<p class="text-inverse text-left"><a href="${pageContext.request.contextPath }/login/loginForm.do"><b>Back to website</b></a></p>
								</div>
								<div class="col-md-2">
...
$(function(){
	...
	$('#send_mail').click(function(){
		...
		if ($('#mem_mail').val() == null || $('#mem_mail').val() == "") {
			...
			$.ajax({
				type : 'POST',
				url : '${pageContext.request.contextPath}/admin/member/sendCode.do',
				dataType : 'json', 
				data : { 
...
// 			return false;
			return submitFail('아이디');
		}
		id_flag = false;
		
		$.ajax({
			type : 'POST',
			url : '${pageContext.request.contextPath}/admin/member/memberForm/idChk.do',
			dataType : 'json',
