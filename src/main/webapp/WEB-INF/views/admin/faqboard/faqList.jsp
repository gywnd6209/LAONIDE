					...
					<div class="card">
						...
						<div class="card-block table-border-style">
							<div class="table-responsive">
								...
								<br/>
								<div>
									<form action="${pageContext.request.contextPath }/admin/faqboard/faqList.do" method="post" class="form-inline pull-right">
...
$(function() {
	...
	$("#btn_write").click(function() {
		$(location).attr("href","${pageContext.request.contextPath}/admin/faqboard/faqForm.do");
	});
		
	//글보기
	$("#faqTable tr").click(function() {
		var bo_no = $(this).find("td:eq(0) input").val();
		$(location).attr("href","${pageContext.request.contextPath}/admin/faqboard/faqView.do?bo_no="+ bo_no+"&currentPage=${currentPage}&search_keyword="+encodeURI("${search_keyword}")+"&search_keycode=${search_keycode}");
// 		$(location).attr("href","${pageContext.request.contextPath}/admin/faqboard/faqView.do?bo_no="+ bo_no);
	});
