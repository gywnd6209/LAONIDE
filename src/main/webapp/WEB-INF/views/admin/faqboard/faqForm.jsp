...
$(function(){
	...
	$("form[name=registFrm]").submit(function(){
		...
		$(this).attr("action", "${pageContext.request.contextPath }/admin/faqboard/insertFaqInfo.do");
	...
	$("#btn_list").click(function(){
		$(location).attr("href","${pageContext.request.contextPath}/admin/faqboard/faqList.do?currentPage=${currentPage}&search_keyword=${search_keyword}&search_keycode=${search_keycode}");
	});
