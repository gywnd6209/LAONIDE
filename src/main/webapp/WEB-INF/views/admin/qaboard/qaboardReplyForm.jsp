...
<!-- 		               </div> -->
		               ...
		               <div class="form-group row">
		                   ...
		                   <div class="col-sm-10">
		                       ...
		                       placeholder="답변 내용을 입력하세요." onKeyUp="javascript:fnChkByte(this,'1000')"></textarea>
		...
		$('#btn1').click(function(){
			...
			if(content1 == '' || content1 == null){
			 ...
			 $('form[name=insertFrm]').submit(function(){
			    	...
			    	$(this).attr('action', '${pageContext.request.contextPath}/admin/qaboard/insertQaboardReply.do'); 
					...
					$(this).append('<input type="hidden" name="admin_id" value="'+mem_id+'" ></input>' );
