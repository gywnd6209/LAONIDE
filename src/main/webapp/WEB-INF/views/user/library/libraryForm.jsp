...
// document.fileForm.files.files[0].size;
...
$(function() {
	...
	$('form[name=registFrm]').submit(function(){
		...
		$(this).attr('action', '${pageContext.request.contextPath }/user/library/insertLibraryInfo.do');
...
function sizeCheck1() {
	...
	if(size1 != 0){
		...
		alert("현재 첨부된 파일 사이즈는 " + cal_size.toFixed(2) + "MB입니다.");
	}
