                        ...
                        <form class="md-float-material form-material">
                            ...
                            <div class="text-center" style="height: 150px;">
                                ...
                                <img width="80px;" src="${pageContext.request.contextPath }/assets/images/logolaon.png" alt="logo.png">
                                          ...
                                          <h7 align="center">비밀번호 찾기</h7><br/>
                                          <h6 align="center">라온IDE에 등록된 아이디와 이메일을 입력해주세요!</h6><br/>
                                        </div>
                                    </div>
...
//    });
   ...
   $('#findIDBtn').click(function () {
	   ...
	   $(location).attr('href', '${pageContext.request.contextPath }/login/findIDForm.do');
   });
