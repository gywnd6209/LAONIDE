					...
					<div class="card">
						...
						<div class="card-block table-border-style">
							<div class="table-responsive">
								<table id="libararyTable" class="table table-hover">
									<thead>
										<tr>
											<th>NO</th>
											<th>TITLE</th>
								...
								<br/>
								<div>
									<form action="${pageContext.request.contextPath }/admin/library/libraryList.do" method="post" class="form-inline pull-right">
...
$(function() {
	...
	$("#btn_write").click(function() {
		if(eval('${!empty LOGIN_ADMININFO}')){
			$(location).attr("href","${pageContext.request.contextPath}/admin/library/libraryForm.do");
		}else{
	...
	$("#libararyTable tr").click(function() {
		...
		$(location).attr("href","${pageContext.request.contextPath}/admin/library/libraryView.do?bo_no="+ bo_no +"&currentPage=${currentPage}&search_keyword="+encodeURI("${search_keyword}")+"&search_keycode=${search_keycode}");
	});
