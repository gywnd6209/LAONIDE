...
<%-- 			            	<c:if test="${recruitboardInfo.bo_status =='y'}"> --%>
<!-- 			            	<tr> -->
<%-- 			                  <td align="center"><input type="hidden" value="${recruitboardInfo.bo_no}"/>${recruitboardInfo.rnum}</td> --%>
<!-- 			                  <td colspan="4" style="color:red" align="left"> -->
<!-- 			                     	 삭제된 글입니다. -->
<!-- 			                   </td> -->
<!-- 			               </tr> -->
<%-- 			            	</c:if> --%>
<%-- 			            	<c:if test="${recruitboardInfo.bo_status =='n' }"> --%>
			            	<tr>
			                  <td align="center"><input type="hidden" value="${recruitboardInfo.bo_no}"/>${recruitboardInfo.rnum}</td>
			                  <td align="center">
			                     ${recruitboardInfo.bo_title}
			                     </td>
...
<%-- 			            	</c:if> --%>
			...
			<div style="margin-left: auto;">
				<form action="${pageContext.request.contextPath }/admin/recruitboard/recruitboardList.do" method="post" class="form-inline pull-right">
...
//       }
       ...
       if(eval('${!empty LOGIN_ADMININFO}')){ 
            $(location).attr('href', '${pageContext.request.contextPath}/admin/recruitboard/recruitboardView.do?bo_no=' + bo_no+'&rnum='+rnum
