...
function fnChkByte(obj, maxByte){
	...
	$(function(){
		...
		$('#bo_content').val('${qaboardReplyInfo.bo_content}');
...
// 			location.href='${pageContext.request.contextPath}/user/qaboard/deleteQaboardReply.do?bo_no='+${qaboardInfo.bo_no};
			location.href='${pageContext.request.contextPath}/user/qaboard/deleteQaboardReply.do?bo_no='+${qaboardReplyInfo.bo_no};
		});
