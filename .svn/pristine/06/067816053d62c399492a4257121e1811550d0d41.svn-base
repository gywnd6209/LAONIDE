...
<body>
	...
	<div>
		<form name="searchFrm" action="${pageContext.request.contextPath }/user/notice/noticeList.do" method="post"
...
<script type="text/javascript">
	$(function() {
		...
		$('#noticeTBL tr').click(function() {
			...
			$(location).attr("href","${pageContext.request.contextPath}/user/notice/noticeView.do?bo_no="+ bo_no +"&currentPage=${currentPage}&search_keyword=" + encodeURI('${search_keyword}')+"&search_keycode=${search_keycode}");
		});
...
// 			$(this).attr('action', '${pageContext.request.contextPath}/user/notice/noticeList.do'); 
// 		});
